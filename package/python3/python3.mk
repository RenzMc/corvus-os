...
# Python3 doesn't support some of the default configure options
...
# Host-Python3 doesn't support most of the default host autotools configure options
# Override to eliminate "unrecognized options" warnings
HOST_HOST_PYTHON3_CONF_OPTS = \
	--disable-shared \
	--enable-static \
	--disable-gtk-doc \
